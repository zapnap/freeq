 ...
 */
import type { Message, Member, WhoisInfo, ChannelListEntry, AvSession, TransportState, PinnedMessage } from './types.js';
...
export interface FreeqEvents {
    ...
    memberJoined: (channel: string, member: Partial<Member> & {
        nick: string;
    }) => void;
    ...
    membersList: (channel: string, members: Array<Partial<Member> & {
        nick: string;
    }>) => void;
...
export declare class EventEmitter {
    ...
    protected emit<K extends keyof FreeqEvents>(event: K, ...args: Parameters<FreeqEvents[K]>): void;
